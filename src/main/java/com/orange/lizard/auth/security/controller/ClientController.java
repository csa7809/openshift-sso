...
import com.orange.lizard.auth.security.editors.AuthorityPropertyEditor;
import com.orange.lizard.auth.security.editors.SplitCollectionEditor;
...
public class ClientController {
	...
	public ClientController(){
		LOGGER.info("Constructor : ClientController");
	}
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN','ROLE_OAUTH_ADMIN')")
